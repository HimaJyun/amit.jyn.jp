...
構文は/rg define \<保護名\> \<自分の名前\>ですが、ここで"自分の名前"は絶対に入力し忘れないよう気を付けてください。

自分の名前を入力しない、または打ち間違えると**自分でも操作できない保護**になってしまいます。

もし、操作できない保護になった場合はBBSで報告するか、モデレーターさんに削除をお願いしてください。
{{</tips>}}
