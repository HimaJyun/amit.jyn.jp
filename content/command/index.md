...
次に、売りたいアイテムを持ちます。
そしたらコマンド欄に/shop create [一度に売買する個数] [売値] [買値]
その後、15秒以内にショップにしたいチェストを叩けばショップが出来上がります。
...
価格:  
販売専用なら /shop create [一度に売買する個数] [売値] 0  
両方取り扱うのならば /shop create [一度に売買する個数] [売値] [買値]」でコマンドを打ってください。
...
例えば、64個の丸石を150アミトで販売、100アミトで買取しているお店があるとします。  
